...
public class ParcoursUnitTest
{
    ...
    public async Task CreateParcoursUseCase()
    {
        ...
        Parcours parcoursFinal = new Parcours
            { Id = idParcours, NomParcours = nomParcours, AnneeFormation = anneFormation };
    ...
    public async Task AddUeDansParcoursUseCase()
    {
        ...
        Ue ue = new Ue { Id = idUe,NumeroUe = "num_ue_1", Intitule = "BDD"};
        Parcours parcours = new Parcours
        {
            Id = idParcours,
            NomParcours = "parcours_initial",
            AnneeFormation = 2025,
